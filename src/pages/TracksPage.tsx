                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center justify-center hover:scale-110 transition-transform cursor-pointer" title="SoundCloud">
                                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#FF5500">
                                        <path d="M11.17 11.18c0-.223-.007-.468-.02-.72l-1.076 5.617v.1h-4.408v-.4c-3.11-.274-5.592-2.92-5.592-6.178 0-3.35 2.584-6.086 5.864-6.32v.42c.006-.156.026-.3.047-.442H6.012c0-1.257 1.026-2.28 2.29-2.28.614 0 1.176.242 1.598.638l-.087-.087c.88.905 1.436 2.146 1.436 3.518v5.187l-.078.956zm.924.977l.84-5.75v5.75h-.84zm8.625-5.32c1.814 0 3.284 1.478 3.284 3.3s-1.47 3.3-3.284 3.3h-7.644V8.415c.03-.54.088-1.067.172-1.57h.002c1.24 1.575 3.08 2.616 5.167 2.767-.02.433-.033.88-.033 1.34h2.336zM14.77 7.045v6.828h-1.084V6.66c.405.09.79.222 1.084.385zm-.055-1.53c.12-.224.267-.433.424-.627v5.876h-.566V5.5l.142.016zM13.12 7.5v6.368h-.83V8.842l.83-1.342zm-1.027 3.368v3H11.27v-2.02l.823-1.002v.02zm.12-3.3l-.066 2.583-.755.918v.5h-.876v-6.42l1.697 2.42z" />
                                    </svg>
                                </div>
