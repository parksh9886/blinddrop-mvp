            ...
            <AnimatePresence>
                {showCopyToast && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 50 }}
                        className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[200] px-6 py-3 bg-white text-slate-900 rounded-full shadow-xl font-medium text-sm"
                    >
                        Link copied! Share this track.
                    </motion.div>
                )}
            </AnimatePresence>
        </div>
